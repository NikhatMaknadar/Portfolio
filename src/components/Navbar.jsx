...
const Navbar = () => {
  return (
    <header className="flex  fixed py-2 px-3 bg-[#48016b] w-full overflow-hidden  z-30 top-0">
        ...
        >
          <a href="/#">
            <h1 className="font-bold  md:text-2xl text-2xl text-white cursor-pointer">
              &lt;Code.<span className="text-[#f7ff8a]">Nikhat/&gt;</span>
            </h1>
          </a>
          ...
          <div className="md:flex w-fit sm:ml-4 gap-3 hidden">
            ...
            <motion.div
              ...
              transition={{ type: 'spring', stiffness: 400, damping: 17 }}
            >
              <a href="https://github.com/NikhatMaknadar" className="self-center">
